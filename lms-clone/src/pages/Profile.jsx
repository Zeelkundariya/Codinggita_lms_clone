      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-8 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="md:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-3">
            <Field label="Enrollment Number" value="SUK250054CE089" />
        ...
        <Section title="Contact & Links">
          ...
          <Field label="Portfolio" value="https://zeelkundariya-porfolio.netlify.app/" />
          <Field label="Resume" value="—" />
          <FieldLink label="Github" value="https://github.com/Zeelkundariya" />
          <FieldLink label="LinkedIn" value="www.linkedin.com/in/zeel-kundariya" />
          <FieldLink label="Twitter" value="https://x.com/ZeelKundariya" />
          <FieldLink label="YouTube" value="https://www.youtube.com/@ZeelKundariya" />
        </Section>
